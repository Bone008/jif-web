 ...
 * shortcuts, no SCSS — used by both the interactive InterfaceJaggedPiece
 * component and by renderJaggedPieceSVGString (via react-dom/server) for bulk
 * export. Lives in its own file (free of stylesheet imports) so a Node tsx
 * script can render it without a browser bundler.
 */
